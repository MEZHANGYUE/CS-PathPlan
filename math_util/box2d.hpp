...
public:
  ...
  /**
   * @brief Getter of the axis of the box
   * @return The axis of the box
   */
  ...
  /**
   * @brief Compute the square of the shortest distance from box to a given
   * point.
   * @param point The point whose distance to the box we wish to compute
  ...
  /**
   * @brief Determines whether this box overlaps a given polyline
   *
   * @param polyline The polyline
   * @return True if they overlap
   */
  // bool HasOverlap(const Polyline2d & polyline) const;
